...
exports.updateDependencies = function(src, data){
    ...
    if(lib.isPlainObject(data)){
        // 添加默认版本修饰符
        JSONData.dependencies[data.name] = initVersionModifier + data.version;
    }
    // 更新多项
    else if(Array.isArray(data)){
        data.forEach(function(item){
            // 添加默认版本修饰符
            JSONData.dependencies[item.name] = initVersionModifier + item.version;
        })
    }
...
exports.installDependencies = function(name){
    // 1.查询aimee.json
...
exports.reg = function(commander){
    commander
        ...
        .action(function(argv, options){
            ...
            if(!argv){
                exports.installDependencies('app')
