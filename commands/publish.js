...
exports.publish = function(fn){
    ...
    exports.package(function(e, filepath){
        ...
        // TODO：包括非200的任何错误
        http.form(options, opt, function(e, res, msg){
            if(e) throw e;
...
exports.reg = function(commander){
    commander
        ...
        .action(function(){
            ...
            // 查询服务器当前模块的相关信息
            // 特殊的内部网络限制原因，提交采用直连不走代理，其他如查询、安装、注册、登陆等走代理
            // exports.aimee.cli.info.query(config.name, function(err, res, msg){
            request(exports.aimee.url('query', 'name=' + config.name), function(err, res, msg){
                var info;
